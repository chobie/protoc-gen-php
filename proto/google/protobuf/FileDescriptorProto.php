...
class FileDescriptorProto extends \ProtocolBuffers\Message
{
  ...
  protected $name;
  /** @var string $package tag:2  optional */
  protected $package;
  /** @var array $dependency tag:3  optional */
  protected $dependency;
  /** @var array $public_dependency tag:10  optional */
  protected $public_dependency;
  /** @var array $weak_dependency tag:11  optional */
  protected $weak_dependency;
  /** @var array $message_type tag:4  optional */
  protected $message_type;
  /** @var array $enum_type tag:5  optional */
  protected $enum_type;
  /** @var array $service tag:6  optional */
  protected $service;
  /** @var array $extension tag:7  optional */
  protected $extension;
  /** @var \google\protobuf\FileOptions $options tag:8  optional */
  protected $options;
  /** @var \google\protobuf\SourceCodeInfo $source_code_info tag:9  optional */
